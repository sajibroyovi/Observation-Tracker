                ...
                <div class="glass-card mb-4 p-3 py-1">
                    <form method="GET" class="row g-2 align-items-end">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="search" class="form-control form-control-sm border-0 bg-light" placeholder="Name, Desc..." value="<?php echo htmlspecialchars($_GET['search'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                        </div>
