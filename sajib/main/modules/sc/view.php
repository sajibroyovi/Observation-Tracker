...
$count_sql = "SELECT COUNT(*) as total FROM security_mail" . $where;
...
// Fetch data from security_mail table with filters and limit
$sql = "SELECT * FROM security_mail " . $where . " ORDER BY serial_no DESC LIMIT $limit OFFSET $offset";
...
// Module Stats
$_stats = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as total, SUM(status='Pending') as pending, SUM(status='Answered') as answered, SUM(status='Follow_up') as follow_up FROM security_mail")) ?: [];
...
<head>
    ...
    <title>View Security Mail</title>
        ...
        <div class="main-content">
            ...
            <div class="container-fluid ps-0 mt-3">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="view-header fw-bold mb-1"><i class="fa-solid fa-shield-halved text-orange me-2"></i> Security Mail Records</h1>
                        <p class="text-muted small mb-0">Monitor high-priority security alerts and escalated communications.</p>
                    </div>
                    <div class="d-flex gap-2">
                        <?php if (canEditGlobal()): ?>
                        <button class="btn btn-primary btn-sm rounded-pill shadow-sm px-4" data-bs-toggle="modal" data-bs-target="#staticBackdrop_scmail">
                    ...
                    <div class="row align-items-center g-3">
                        <div class="col-md-8">
                            <div class="d-flex align-items-center gap-4 flex-wrap">
                                <div class="stat-icon-wrapper bg-orange bg-opacity-10 text-orange rounded d-flex align-items-center justify-content-center shadow-sm" style="width: 48px; height: 48px;">
                        ...
                        <table class="table table-hover align-middle mb-0 dashboard-table">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    if ($priority == 'high') {
                                        $priority_badge = '<span class="status-badge bg-danger bg-opacity-10 text-danger fw-bold p-2 px-3 rounded-pill"><i class="fa-solid fa-shield-virus me-1"></i> High</span>';
                                    } else if ($priority == 'medium') {
                                        $priority_badge = '<span class="status-badge bg-warning bg-opacity-10 text-warning fw-bold p-2 px-3 rounded-pill"><i class="fa-solid fa-shield me-1"></i> Medium</span>';
                                    } else if ($priority == 'low') {
                                        $priority_badge = '<span class="status-badge bg-success bg-opacity-10 text-success fw-bold p-2 px-3 rounded-pill"><i class="fa-solid fa-shield-heart me-1"></i> Low</span>';
                                    }
