...
// Module Stats
$_stats = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as total, SUM(status='live') as live, SUM(status='scheduled') as scheduled, SUM(status='draft') as draft FROM promo_banner")) ?: [];
$_progress = ($_stats['total'] > 0) ? round(($_stats['live'] / $_stats['total']) * 100) : 0;
?>
            ...
            <div class="container-fluid ps-0 mt-3">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <?php endif; ?>
                        <a href="<?= BASE_URL ?>/modules/export/export?module=promo_banner&<?= e(http_build_query($_GET)) ?>" class="btn btn-outline-success btn-sm rounded-pill shadow-sm px-3 bg-white border-0 btn-export-view"><i class="fa-solid fa-file-export me-1"></i> Export</a>
                    ...
                    <div class="row align-items-center g-3">
                        <div class="col-md-8">
                            <div class="d-flex align-items-center gap-4 flex-wrap">
                                ...
                                <div class="stat-item border-end pe-4">
                                    <div class="small-caps text-muted mb-1">Live</div>
                                    <div class="h4 fw-bold mb-0 text-success"><?= (int)($_stats['live'] ?? 0) ?></div>
                                </div>
                                <div class="stat-item border-end pe-4">
                                    <div class="small-caps text-muted mb-1">Scheduled</div>
                                    <div class="h4 fw-bold mb-0 text-primary"><?= (int)($_stats['scheduled'] ?? 0) ?></div>
                                </div>
                                <div class="stat-item border-end pe-4">
                                    <div class="small-caps text-muted mb-1">Draft</div>
                                    <div class="h4 fw-bold mb-0 text-warning"><?= (int)($_stats['draft'] ?? 0) ?></div>
                                </div>
                                <div class="stat-item pe-4">
                                    <div class="small-caps text-muted mb-1">Total Banners</div>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center justify-content-end gap-3">
                                <div class="text-end">
                                    <div class="small-caps text-muted mb-1">Live Rate</div>
                ...
                <div class="glass-card mb-4 p-3 py-1">
                    <form method="GET" class="row g-2 align-items-end">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="search" class="form-control form-control-sm border-0 bg-light" placeholder="Banner Title..." value="<?php echo htmlspecialchars($_GET['search'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                        </div>
